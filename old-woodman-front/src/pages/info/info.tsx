...
const galleryDoorsImages = [
  { src: gallery1d, alt: 'Фрагмент деревянной двери из массива с декоративными резными элементами демонстрирует преимущества дверей из массива' },
  { src: gallery2d, alt: 'Изготовление двери в столярном цеху, элемент двери из массива  на верстаке демонстрирует преимущества дверей из массива' },
  { src: gallery3d, alt: 'Мастер столяр в столярной мастерской работает стамеской по классической технологии' },
  { src: gallery4d, alt: 'Фрагмент в разрезе настоящей деревянной двери из массива в столярной мастерской ' },
  { src: gallery5d, alt: 'Фрагмент деревянной двери из массива в столярной мастерской демонстрирует как устроена настоящая деревянная дверь' },

];

const galleryFurnitureImages = [
  { src: gallery1f, alt: 'Красивая деревянная тумбочка из массива с натуральной фактурой и рисунком натуральной древесины демонстрирует преимущества деревянной мебели' },
  { src: gallery2f, alt: 'Руки мастера столяра размечают древесину для изготовления деревянной мебели в столярной мастерской' },
  { src: gallery3f, alt: 'Деревянный дубовый стол, вид сверху на красивую фактуру и рисунок дерева для демонстрации красоты мебели из массива' },
  { src: gallery4f, alt: 'Фактура и рисунок древесины на деревянном столе для демонстрации преимуществ мебели из натурального массива' },
  { src: gallery5f, alt: 'Руки мастера столяра настраивают пилу для изготовления деревянной мебели в столярной мастерской' },
