...
const NavigationBlock: React.FC<NavigationBlockProps> = ({
    ...
    return (<div className={`${styles.navigation}  ${!isHome && screenWidth >= 1200 ? styles.navigationCustom : ''}`}>
        {blocks.includes('doors') && (<div className={`${styles.background} ${styles.brown} ${kazah ? styles.kazah : ''}`}>
            ...
            <img className={styles.imageSmall} src={door1} loading={'lazy'}
                 alt="Деревянная дверь со стеклопакетом на коричневом фоне"/>
            <img className={styles.imageBig} src={door2} loading={'lazy'}
                 alt="Белая классическая дверь с наличником на коричневом фоне"/>
        </div>)}
        {blocks.includes('furniture') && (<div className={`${styles.background} ${styles.blue} ${kazah ? styles.kazah : ''}`}>
                ...
                <img className={styles.imageBig} src={shelf} loading={'lazy'}
        ...
        {blocks.includes('facades') && (<div className={`${styles.background} ${styles.yellow}`}>
            ...
            <img className={styles.imageSmall} src={facade1} loading={'lazy'}
                 alt="Декоративная стеновая панель с готической росписью"/>
            <img className={styles.imageBig} src={facade2} loading={'lazy'}
                 alt="Деревянный мебельный фасад из массива сосны "/>
        </div>)}
        {blocks.includes('gifts') && (<div className={`${styles.background} ${styles.orange}`}>
            ...
            <img className={styles.imageSmall} src={gift1} loading={'lazy'}
                 alt="Деревянный светильник эксклюзивный подарок алматы"/>
            <img className={styles.imageBig} src={gift2} loading={'lazy'}
                 alt="Эксклюзивные часы из древесины карагача"/>
        </div>)}
    </div>);
};
