            ...
            <header className={styles.header}>
                <div className={styles.container}>
                    ...
                    <div className={styles.menu}>
                        <NavLink to="/doors"
                                 className={({isActive}) => getNavLinkClass(isActive)}>{t('doors')}</NavLink>
                        <NavLink to="/furniture"
                                 className={({isActive}) => getNavLinkClass(isActive)}>{t('furniture')}</NavLink>
                        <NavLink to="/facades"
                        ...
                        <NavLink to="/contacts"
                                 className={({isActive}) => getNavLinkClass(isActive)}>{t('contacts')}</NavLink>
                    </div>

                    <div className={styles.contactBtn}>
                        <OvalButton theme = 'yellow' text={t('connect')} onClick={() => showModal(<ContactsModal/>)}/>
                    </div>
                    ...
                    <div className={styles.right}>
                        ...
                        <div className={styles.burger} onClick={isMenuOpen ? handleBurgerClose : handleBurgerOpen}>
                            {isMenuOpen
                                ? <CircleButton ariaLabel={t('header.aria-label')} icon={<CloseIcon/>}
                                                bgColor="transparent"/>
                                : <BurgerIcon/>}
                        </div>
